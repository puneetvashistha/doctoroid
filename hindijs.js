      ...
      recognition.onresult = (event) => {
        ...
        console.log(transcript);
          ...
          else if(transcript.includes('जोड़ों')){
              recognition.stop();
              utter.text = "ज़रूर, मैं यहाँ आपकी जोड़ों की समस्या से निपटने में आपकी मदद करने के लिए हूँ। ऐसे कई आयुर्वेदिक घरेलू उपचार हैं जिनका उपयोग आप घर पर जोड़ों के लिए कर सकते हैं जैसे, पहले अदरक के रस में एक नींबू का रस और आधा चम्मच शहद मिलाकर पिएं. घुटनों और कमर के प्रभावित हिस्से की अदरक के तेल से मालिश करने से दर्द में राहत मिलेगी. एक्सपर्ट्स के मुताबिक, प्याज और लहसुन के सेवन से जोड़ों के दर्द में आराम मिलता है. इनमें मौजूद तत्व जोड़ों के दर्द के लिए फायदेमंद होते हैं. उम्मीद है की ये मदद करेगा.. क्या आपको और मदद चाहिए??"; 
              synth.speak(utter);
          }
                                                
          else if(transcript.includes('बालों')){
              recognition.stop();
              utter.text = "ज़रूर, मैं यहाँ आपकी बालों की समस्या से निपटने में आपकी मदद करने के लिए हूँ। ऐसे कई आयुर्वेदिक घरेलू उपचार हैं जिनका उपयोग आप घर पर बालों के लिए कर सकते हैं जैसे, पहले आंवला इसमें आपके लिए फायदेमंद साबित होगा, साथ ही साथ नारियल का तेल और प्याज का रस फायदेमंद साबित होगा. उम्मीद है की ये मदद करेगा.. क्या आपको और मदद चाहिए??"; 
              synth.speak(utter);
          }
